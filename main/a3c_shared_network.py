...
class Agent(threading.Thread):
    def __init__(self, state_input_shape, action_output_shape, threadid):
        ...
        # Actor weights
        weights_actor = [weights[0], weights[1], weights[2], weights[3]]
        weights_critic = [weights[0], weights[1], weights[2], weights[4]]
        ...
        writer = tf.summary.FileWriter("/tmp/LSDAIntro", sess.graph)
    def run(self):
        self.train(50, 5000)
        print("It worked!")
    ...
    def train(self, t_max, episodes):
        ...
        while i < episodes: 
            ...
            while not done:
                ...
                action = np.random.choice([1, 4, 5], p=probabilities[0])
